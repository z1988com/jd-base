...
if [[ ${WhichDep} == *github* ]]; then
  ...
  ScriptsURL=https://github.com/z1988com/jd_scripts
  ShellURL=https://github.com/z1988com/jd-base
else
  ScriptsURL=https://gitee.com/z1988com/jd_scripts
  ShellURL=https://gitee.com/z1988com/jd-base
fi
